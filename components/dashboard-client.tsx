  ...
  return (
    <div className="flex flex-1 flex-col gap-6 py-6">
      ...
      <div className="px-4 lg:px-6">
        <div className="flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            Manage expenses that affect your yearly revenue
          </div>
      ...
      <div className="px-4 pb-2 text-xs text-muted-foreground lg:px-6">
        Note: Revenue calculations assume active contracts cover the shown
        months. Add global items like taxes/insurance as Yearly, and
        utilities/maintenance as Monthly for accurate projections.
      </div>
    </div>
  )
}
